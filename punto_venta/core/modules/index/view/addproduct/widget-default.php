...
<div class="box box-solid box-primary">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">C&oacutedigo*</label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Descripci&oacuten</label>
    <div class="col-md-8">
      <textarea name="description" class="form-control" id="name" placeholder="Caracteristicas del Producto"></textarea>
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Preparacion*</label>
    <div class="col-md-8">
      <textarea name="preparation" class="form-control" id="name" placeholder="Preparacion del Producto"></textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-3 control-label">Duraci&oacuten</label>
    <div class="col-md-8">
...
<p class="alert alert-info">* Campos obligatorios: Código,Nombre, Precio, Unidad, Categoria</p>
