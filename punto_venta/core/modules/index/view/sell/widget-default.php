...
<section class="content-header" id="cDark">
		<h1 id="onsellContent" >Venta</h1>
</section>
...
<!--	<a href="index.php?view=selln" class="btn btn-default btn-lg pull-right">Venta sin factura <i class="glyphicon glyphicon-chevron-right"></i></a> -->
	...
	<p  class="alert alert-success" ><b>Buscar producto por nombre o por código:</b></p>
		<form>
		<div class="row">
			<div class="col-md-6">
...
if(count($products)>0){
	?>
<div id="textWhite">
<h3 id="cDark" >Resultados de la Búsqueda</h3>
</div>
        <div class="" id="cDark">
...
<table class="table table-bordered" id="textwhite">
<tr>
...
<tr>
	<td id="cRed"><p>Total</p></td>
	<td id="btnconf"><p><b>$ <?php echo number_format($total); ?></b></p></td>
</tr>
